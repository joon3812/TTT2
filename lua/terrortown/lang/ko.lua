...
-- 2020-02-11
L.automoved_to_spec = "(자동화 메시지) 저는 잠수로 인해 관전자팀으로 이동되었습니다."
L.mute_team = "{team} 음소거됨."
...
L.submenu_appearance_dmgindicator_title = "피해 감지기"
...
L.submenu_gameplay_avoidroles_title = "직업 회피"
...
L.label_performance_spec_outline_enable = "조종되고있는 물체의 외곽선 활성화"
L.label_performance_ohicon_enable = "플레이어의 머리위에 직업 아이콘 보이기"
L.label_interface_tips_enable = "관전중 화면하단에 게임플레이 팁 보이기"
...
L.header_hud_customize = "HUD 사용자지정"
L.header_vskin_select = "VSkin 선택 및 사용자지정"
...
L.item_speedrun_desc = [[당신을 50% 더 빠르게 만듭니다!]]
L.item_no_explosion_damage = "폭발 피해 무효화"
L.item_no_explosion_damage_desc = [[당신을 폭발 피해 면역이 됩니다.]]
L.item_no_fall_damage = "추락 피해 무효화"
L.item_no_fall_damage_desc = [[추락으로 인해 받는 피해 면역이 됩니다.]]
L.item_no_fire_damage = "불 피해 무효화"
L.item_no_fire_damage_desc = [[불로 인해 받는 피해 면역이 됩니다.]]
...
L.item_no_drown_damage_desc = [[익사로부터 받는 피해를 무효화합니다.]]
...
L.message_revival_failed_missing_body = "시체가 더 이상 존재하지않아 부활에 실패했습니다."
L.hud_revival_title = "부활 까지 남은 시간:"
...
-- 2020-05-28
L.confirm_detective_only = "탐정만 시신 확정이 가능합니다."
L.inspect_detective_only = "탐정만 시신 수색이 가능합니다."
L.corpse_hint_no_inspect = "이 시신은 탐정만 수색이 가능합니다."
L.corpse_hint_inspect_only = "[{usekey}]키를 눌러 수색하기. 탐정만 시신 확정 가능."
L.corpse_hint_inspect_only_credits = "[{usekey}]키를 눌러 크레딧 받기. 탐정만 시신 수색 가능."
...
L.binoc_help_pri = "시체 수색하기."
L.binoc_help_sec = "배율 변경."

L.vis_help_pri = "활성화된 장치 떨어뜨리기."

L.decoy_help_pri = "교란기 설치."

-- 2020-08-07
L.pickup_error_spec = "관전자로 이것을 집을 수 없습니다."
L.pickup_error_owns = "이 무기가 이미 있어서 집을 수 없습니다."
...
L.hilite_win_traitors = "트레이터 팀 승리"
L.hilite_win_innocents = "이노센트 팀 승리"
L.hilite_win_tie = "무승부"
L.hilite_win_time = "시간 초과"

L.tooltip_karma_gained = "이번 라운드로 얻은 카르마:"
L.tooltip_score_gained = "이번 라운드로 얻은 점수:"
L.tooltip_roles_time = "Roles over time:"

L.tooltip_finish_score_alive_teammates = "살아있는 팀원: {score}"
L.tooltip_finish_score_alive_all = "살아있는 플레이어: {score}"
...
L.finish_score_alive_teammates = "살아있는 팀원:"
L.finish_score_alive_all = "살아있는 플레이어:"
...
L.title_event_c4_disarm = "C4 폭약이 해제되었습니다"
L.title_event_c4_explode = "C4 폭약이 폭발했습니다"
L.title_event_c4_plant = "C4 폭약이 설치되었습니다"
L.title_event_creditfound = "장비 크레딧을 발견했습니다"
...
L.desc_event_bodyfound = "{finder} ({firole} / {fiteam})(이)가 {found} ({forole} / {foteam})의 시신을 찾았습니다. 시신에는 {credits} 장비 크레딧이 있었습니다."
L.desc_event_bodyfound_headshot = "머리를 맞아 사망했습니다."
L.desc_event_c4_disarm_success = "{disarmer} ({drole} / {dteam})(이)가 {owner} ({orole} / {oteam})(이)가 설치한 폭탄을 해제했습니다."
L.desc_event_c4_disarm_failed = "{disarmer} ({drole} / {dteam})(이)가 {owner} ({orole} / {oteam})(이)가 설치한 폭탄을 해제하려고 했습니다만, 실패했습니다."
L.desc_event_c4_explode = "{owner} ({role} / {team})(이)가 설치한 C4가 폭발했습니다."
L.desc_event_c4_plant = "{owner} ({role} / {team})(이)가 C4를 설치했습니다."
L.desc_event_creditfound = "{finder} ({firole} / {fiteam})(이)가 {credits} 만큼의 장비 크레딧을 {found} ({forole} / {foteam})의 시체에서 찾아냈습니다."
...
L.desc_event_kill_team = "팀에 의해 사살되었습니다."

L.desc_event_kill_blowup = "{victim} ({vrole} / {vteam})(이)가 자폭 했습니다."
...
L.desc_event_kill_sui = "{victim} ({vrole} / {vteam})(은)는 이 상황을 견디지 못해 자살했습니다."
L.desc_event_kill_sui_using = "{victim} ({vrole} / {vteam})(은)는 {tool}(을)를 이용해 자살했습니다."

L.desc_event_kill_fall = "{victim} ({vrole} / {vteam})(이)가 나락으로 떨어졌습니다."
L.desc_event_kill_fall_pushed = "{victim} ({vrole} / {vteam})(이)가 {attacker}에게 밀쳐져 나락으로 떨어졌습니다."
L.desc_event_kill_fall_pushed_using = "{victim} ({vrole} / {vteam})(이)가 {attacker} ({arole} / {ateam})에게 {trap}(을)를 이용해 밀쳐져 나락으로 떨어졌습니다."

L.desc_event_kill_shot = "{victim} ({vrole} / {vteam})(이)가 {attacker}에게 사격 당했습니다."
L.desc_event_kill_shot_using = "{victim} ({vrole} / {vteam})(이)가 {attacker} ({arole} / {ateam})의 {weapon}에 사격 당했습니다."

L.desc_event_kill_drown = "{victim} ({vrole} / {vteam})(이)가 {attacker}에 의해 물에 담궈졌습니다."
L.desc_event_kill_drown_using = "{victim} ({vrole} / {vteam})(은)는 {trap}을 {attacker} ({arole} / {ateam})(이)가 발동시키는 바람에 익사했습니다."

L.desc_event_kill_boom = "{victim} ({vrole} / {vteam})(이)가 {attacker}에 의해 터져버렸습니다."
L.desc_event_kill_boom_using = "{victim} ({vrole} / {vteam})(은)는 {attacker} ({arole} / {ateam})(이)가 {trap}(을)를 발동시켜 터트렸습니다."

L.desc_event_kill_burn = "{victim} ({vrole} / {vteam})(은)는 {attacker}에게 바싹 익혀졌습니다."
...
-- 2021-09-01
L.spawneditor_name = "생성 편집 도구"
L.spawneditor_desc = "무기나, 탄약 및 플레이어 생성지점을 배치합니다. 슈퍼 어드민만 사용이 가능합니다."

L.spawneditor_place = "생성 배치"
L.spawneditor_remove = "생성 제거"
L.spawneditor_change = "생성 유형 변경 ([SHIFT]를 유지해 거꾸로)"
L.spawneditor_ammo_edit = "편집을 유지해 탄약 자동 생성을 무기 생성에"

L.spawn_weapon_random = "무작위 무기 생성"
L.spawn_weapon_melee = "근접 무기 생성"
L.spawn_weapon_nade = "수류탄 무기 생성"
L.spawn_weapon_shotgun = "산탄총 무기 생성"
L.spawn_weapon_heavy = "중화기 무기 생성"
L.spawn_weapon_sniper = "저격 무기 생성"
L.spawn_weapon_pistol = "권총 무기 생성"
L.spawn_weapon_special = "특수 무기 생성"
L.spawn_ammo_random = "무작위 탄약 생성"
L.spawn_ammo_deagle = "데저트이글 탄약 생성"
L.spawn_ammo_pistol = "권총 탄약 생성"
L.spawn_ammo_mac10 = "Mac10 탄약 생성"
L.spawn_ammo_rifle = "소총 탄약 생성"
L.spawn_ammo_shotgun = "산탄총 탄약 생성"
L.spawn_player_random = "무작위 플레이어 생성"

L.spawn_weapon_ammo = " (탄약: {ammo})"

L.spawn_weapon_edit_ammo = "[{walkkey}]를 누른 상태로 [{primaryfire} 또는 {secondaryfire}]를 눌러 이 무기 생성에 탄약 증가/감소"

L.spawn_type_weapon = "이것은 무기 생성 입니다"
L.spawn_type_ammo = "이것은 탄약 생성 입니다"
L.spawn_type_player = "이것은 플레이어 생성 입니다"

L.spawn_remove = "[{secondaryfire}]를 눌러 이 생성 제거하기"

L.submenu_administration_entspawn_title = "생성 편집기"
L.header_entspawn_settings = "생성 편집기 설정"
L.button_start_entspawn_edit = "생성 편집 시작"
L.button_delete_all_spawns = "모든 생성 제거"

L.label_dynamic_spawns_enable = "이 지도에 다이나믹 생성 활성화"
L.label_dynamic_spawns_global_enable = "모든 맵에 커스텀 생성 활성화"

L.header_equipment_weapon_spawn_setup = "무기 생성 설정"
...
L.label_roles_credits_award_kill = "사살에 따른 크레딧 보상"
...
L.label_spawn_wave_interval = "생성 웨이브 주기(초)"
...
L.label_lastwords_chatprint = "입력중 사살당했을시 유언으로 출력하기"
L.label_identify_body_woconfirm = "'확정'버튼을 누르지 않아도 시신 검별"
L.label_announce_body_found = "시신 발견시 알림"
L.label_confirm_killlist = "확정된 시신의 킬 리스트 알림"
L.label_inspect_detective_only = "경찰측 조사 가능 시신 제한"
L.label_confirm_detective_only = "경찰측 확정 가능 시신 제한"
...
L.label_armor_value = "아머 아이템으로 방어구 받기"
...
L.label_spec_prop_maxpenalty = "낮은 조종 보너스 제한"
L.label_spec_prop_maxbonus = "높은 조종 보너스 제한"
...
L.label_karma_low_ban = "낮은 카르마 플레이어 밴"
