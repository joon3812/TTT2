...
L.help_color_desc = "이 설정을 활성화하면, TargetID의 외곽선과 크로스헤어에 사용될 색상을 선택할 수 있습니다."
L.help_scale_factor = "이 배율은 모든 UI 요소에 영향을 줍니다 (HUD, VGUI 그리고 TargetID). 이것은 화면 해상도가 변경되면 자동으로 변경됩니다. HUD를 초기화하려면 이것을 설정하세요!"
L.help_hud_game_reload = "HUD를 지금 사용할 수 없습니다. 서버를 재접속하거나 게임을 재부팅하세요."
L.help_hud_special_settings = "해당 HUD의 세부 설정입니다."
